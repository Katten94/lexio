    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#F9FAFB' }}>
      ...
      <div className="flex-1 flex flex-col items-center" style={{ paddingTop: '40px' }}>
        ...
        <div style={{ width: '360px' }}>
          <h1 className="font-bold mb-2" style={{ fontSize: '22px', color: '#111827', fontFamily: 'Arial' }}>Log ind</h1>
          <p className="mb-8" style={{ fontSize: '13px', color: '#6B7280', fontFamily: 'Arial' }}>Velkommen tilbage — log ind på din konto</p>
          ...
          <p className="text-center" style={{ fontSize: '13px', color: '#6B7280', fontFamily: 'Arial' }}>
            ...
            <a href="/signup" style={{ color: '#0F2A5E', fontWeight: '600', textDecoration: 'none' }}>Opret konto</a>
          </p>
        </div>
      </div>
    </div>
