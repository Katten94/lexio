  ...
  "1": {
    1: [
      ...
      },
      {
        ...
        korrekt: 2,
        forklaring: "Kvalitative dybdeinterviews giver nuancerede og detaljerede svar fra få respondenter — ideelt når man vil forstå hvorfor kunder handler som de gør. Kvantitative metoder er bedre til at måle udbredelse."
      },
      {
    ...
    2: [
      ...
      {
        spoergsmaal: "Hvad forstås ved begrebet 'kognitiv dissonans' i Kotlers model?",
        ...
        korrekt: 1,
        forklaring: "Kognitiv dissonans opstår i efterkøbsfasen når forbrugeren begynder at tvivle på om det var det rigtige valg. Virksomheder kan reducere dette med god kundeservice og kommunikation."
      },
      {
        ...
        korrekt: 2,
        forklaring: "Geografisk segmentering opdeler markedet efter geografisk placering — fx land, region eller by. MENY tilpasser eksempelvis deres sortiment og tilbud efter lokale præferencer."
      },
      {
        ...
        korrekt: 1,
        forklaring: "Behovserkendelse er den første fase i Kotlers model — forbrugeren erkender at han har et behov eller ønske. Reklamens formål er netop at trigge denne fase."
      },
      {
        ...
        korrekt: 2,
        forklaring: "Adfærdsmæssig segmentering baserer sig på forbrugerens faktiske adfærd — køb, søgninger og browsing. Zalando bruger denne data til at personalisere oplevelsen og øge konverteringen."
      },
    ],
    3: [
      {
        ...
        korrekt: 1,
        forklaring: "SWOT-analysen er et strategisk analyseværktøj der kortlægger interne faktorer (styrker og svagheder) og eksterne faktorer (muligheder og trusler) for en virksomhed."
      },
      {
        ...
        korrekt: 1,
        forklaring: "Styrker er interne faktorer virksomheden selv kontrollerer — fx stærk brand eller effektiv produktion. Muligheder er eksterne faktorer i omgivelserne som virksomheden kan udnytte — fx ny teknologi eller voksende marked."
      },
      {
        ...
        korrekt: 2,
        forklaring: "Lave priser og effektiv logistik er interne faktorer som Aldi selv kontrollerer og som giver dem en fordel over konkurrenterne — det er styrker i SWOT-analysen."
      },
      {
        ...
        korrekt: 1,
        forklaring: "Porters Five Forces analyserer fem konkurrencekræfter i en branche: eksisterende konkurrenter, nye aktører, substituerende produkter, leverandørers forhandlingsstyrke og kunders forhandlingsstyrke."
      },
      {
        ...
        korrekt: 3,
        forklaring: "Nye konkurrenter er en ekstern faktor der kan true virksomhedens markedsandele og position — det er en trussel i SWOT-analysen. Eksterne negative faktorer placeres altid som trusler."
      },
    ],
    4: [
      {
        ...
        korrekt: 0,
        forklaring: "De klassiske 4 P'er i marketingmixet er: Produkt (hvad sælger vi), Pris (til hvilken pris), Place/distribution (hvordan når vi kunden) og Promotion/kommunikation (hvordan fortæller vi om det)."
      },
      {
        spoergsmaal: "Joe & The Juice sælger juice til høje priser i et eksklusivt miljø med stærk brandidentitet. Hvilken prisstrategi anvender de primært?",
        svar: ["Penetrationsprissætning", "Skimming-prissætning", "Premium-prissætning", "Konkurrencebaseret prissætning"],
        korrekt: 2,
        forklaring: "Premium-prissætning bruges når en virksomhed positionerer sig som eksklusiv og opkræver højere priser end konkurrenterne. Joe & The Juice bruger stærk brand og oplevelse til at retfærdiggøre prisen."
      },
      {
        ...
        korrekt: 0,
        forklaring: "Push-strategi skubber produktet igennem distributionskanalerne til forbrugeren — fx via salgsstyrke og rabatter til forhandlere. Pull-strategi skaber efterspørgsel hos forbrugerne direkte via markedsføring så de selv efterspørger produktet."
      },
      {
        ...
        korrekt: 2,
        forklaring: "Penetrationsprissætning bruges ved lancering af nye produkter hvor virksomheden sætter en lav pris for hurtigt at tiltrække kunder og erobre markedsandele. Prisen hæves typisk efterfølgende."
      },
      {
        spoergsmaal: "Hvilken distributionsform bruger Zalando når de sælger direkte til forbrugeren via deres eget website uden mellemhandlere?",
        svar: ["Intensiv distribution", "Selektiv distribution", "Eksklusiv distribution", "Direkte distribution"],
        korrekt: 3,
        forklaring: "Direkte distribution betyder at producenten sælger direkte til slutforbrugeren uden mellemhandlere. Zalando er et eksempel på direkte distribution via e-handel — de ejer relationen til kunden og alle data."
      },
    ],
    5: [
      {
        spoergsmaal: "Hvad er SEO og hvad bruges det til?",
        svar: ["Social Engagement Optimization — til at øge følgere på sociale medier", "Search Engine Optimization — til at forbedre synlighed i søgeresultater", "Sales Enablement Operations — til at effektivisere salgsprocesser", "Structured Email Outreach — til email-markedsføring"],
        korrekt: 1,
        forklaring: "SEO (Search Engine Optimization) handler om at optimere en hjemmeside så den rangerer højere i søgemaskiner som Google. God SEO øger den organiske trafik til virksomhedens website uden at betale for annoncering."
      },
      {
        ...
        korrekt: 1,
        forklaring: "Content marketing handler om at skabe og dele relevant og værdifuldt indhold — fx blogindlæg, videoer og guides — der tiltrækker en målgruppe og driver profitable handlinger frem for direkte reklame."
      },
      {
        spoergsmaal: "DSB bruger Instagram til at dele billeder af togrejser og natur. Hvilket formål tjener dette primært?",
        svar: ["Direkte salg af togbilletter", "Branding og at skabe positiv associationer til virksomheden", "Kundeservice og klagehåndtering", "Rekruttering af nye medarbejdere"],
        korrekt: 1,
        forklaring: "Visuelle platforme som Instagram bruges primært til branding — at opbygge en positiv fortælling om virksomheden og skabe emotionelle associationer. DSB bruger det til at positionere togrejsen som en oplevelse frem for blot transport."
      },
      {
        ...
        korrekt: 0,
        forklaring: "Organisk reach er den gratis eksponering en virksomhed opnår via likes, delinger og engagement på sine opslag. Betalt reach er annoncering man betaler for at nå ud til en bredere eller mere præcis målgruppe."
      },
      {
        spoergsmaal: "Novo Nordisk publicerer regelmæssigt videnskabelige artikler og rapporter om diabetes. Hvilken digital markedsføringsstrategi er dette et eksempel på?",
        svar: ["Viral marketing", "Influencer marketing", "Thought leadership og content marketing", "Search Engine Marketing (SEM)"],
        korrekt: 2,
        forklaring: "Thought leadership er en content marketing-strategi hvor virksomheden positionerer sig som ekspert og autoritet inden for sit felt ved at dele viden og indsigt. Det opbygger troværdighed og tillid hos målgruppen."
      },
    ],
    6: [
      {
        ...
        korrekt: 1,
        forklaring: "Ansoff-matricen beskriver fire vækststrategier baseret på kombinationer af nye/eksisterende produkter og markeder: markedspenetration, markedsudvikling, produktudvikling og diversifikation."
      },
      {
        ...
        korrekt: 2,
        forklaring: "Produktudvikling er strategien hvor virksomheden lancerer nye produkter på et eksisterende marked. Arla kender det danske marked og introducerer et nyt produkt til eksisterende og nye kunder."
      },
      {
        ...
        korrekt: 1,
        forklaring: "Branding handler om den samlede opfattelse og identitet en virksomhed skaber hos forbrugerne — ikke kun logo og farver, men værdier, tone of voice, kundeservice og oplevelser. Et stærkt brand skaber loyalitet og differentiering."
      },
      {
        ...
        svar: ["Markedspenetration", "Markedsudvikling", "Produktudvikling", "Diversifikation"],
        korrekt: 1,
        forklaring: "Markedsudvikling er strategien hvor virksomheden tager et eksisterende produkt ind på et nyt marked. Joe & The Juice beholder deres koncept men henvender sig til en ny geografisk målgruppe."
      },
      {
        ...
        korrekt: 0,
        forklaring: "Differentiering handler om at tilbyde noget unikt der adskiller virksomheden fra konkurrenterne på hele markedet. Niche-strategi fokuserer derimod på et smalt og veldefineret segment med specifikke behov."
      },
    ],
  },
}
          ...
          <div>
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-6">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-sm">Se videoen og tag derefter videnchecket for at komme videre. Du skal besvare mindst 60% korrekt for at bestå.</p>
              </div>
            </div>
            <button
          ...
          <div>
            ...
            <div className="bg-gray-100 rounded-full h-2 mb-8">
              <div
                ...
                style={{ width: `${((aktivtSpoergsmaal + 1) / quiz.length) * 100}%` }}
              ></div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8 mb-6">
              ...
              <div className="space-y-3">
                {aktivtQ.svar.map((svar, i) => {
                  ...
                  if (!harValgt) {
                    klasse += "border-gray-200 hover:border-blue-300 bg-white text-gray-700 cursor-pointer"
                  } else if (i === aktivtQ.korrekt) {
                    klasse += "border-green-400 bg-green-50 text-green-800"
                  } else if (i === valgtSvar && i !== aktivtQ.korrekt) {
                    klasse += "border-red-300 bg-red-50 text-red-700"
                  } else {
                    klasse += "border-gray-100 bg-gray-50 text-gray-400 cursor-not-allowed"
                  }
        ...
        {fase === 'resultat' && (
          <div className="text-center">
            ...
            {bestaaet ? (
              <div className="space-y-3">
                <button
                  onClick={() => router.push(`/kurser/${kursusId}/modul/${modulId + 1}`)}
                  className="w-full bg-blue-900 text-white py-3 rounded-xl font-medium hover:bg-blue-800">
                  Næste modul →
                </button>
                <button
                  onClick={() => router.push(`/kurser/${kursusId}`)}
