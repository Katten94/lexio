...
const kurser = [
  { id: 1, titel: "Markedsanalyse og forbrugeradfærd", fag: "Afsætning A", niveau: "GF2 · HF1", moduler: 6, varighed: "2,5 timer", beskrivelse: "Lær at analysere markeder og forbrugeradfærd med udgangspunkt i Kotlers købsprocessmodel, segmentering og SWOT. Kurset er forankret i bekendtgørelsen for Afsætning A.", farve: "blue" },
  { id: 2, titel: "Salgspsykologi og kundehåndtering", fag: "Salg og service", niveau: "HF1", moduler: 5, varighed: "2 timer", beskrivelse: "Bliv opdateret på moderne salgsteknikker, kundetyper og reklamationshåndtering med cases fra dansk detailhandel.", farve: "teal" },
  { id: 3, titel: "Budgettering og regnskabsforståelse", fag: "Erhvervsøkonomi B", niveau: "GF2", moduler: 5, varighed: "2 timer", beskrivelse: "Styrk din undervisning i resultatopgørelse, budgetlægning og likviditetsstyring med aktuelle SMV-cases fra dansk erhvervsliv.", farve: "green" },
  { id: 4, titel: "Digital kommunikation og branding", fag: "Kommunikation", niveau: "GF2", moduler: 4, varighed: "1,5 timer", beskrivelse: "Opdater din viden om målgruppeanalyse, kanalvalg og SoMe-strategi med cases fra LEGO, Novo Nordisk og DSB.", farve: "purple" },
  { id: 5, titel: "AI i den merkantile undervisning", fag: "Didaktik", niveau: "Alle niveauer", moduler: 4, varighed: "1,5 timer", beskrivelse: "Forstå hvordan AI kan bruges i din undervisning — didaktisk forsvarligt og forankret i bekendtgørelsen.", farve: "amber" },
]
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 ml-56 px-8 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-900">Kurser</h2>
          <p className="text-gray-500 mt-1">Alle kurser er forankret i Undervisningsministeriets bekendtgørelser</p>
        </div>
              ...
              <Link key={kursus.id} href={`/kurser/${kursus.id}`}>
                <div className={`bg-white rounded-xl border border-gray-200 ${f.border} hover:shadow-sm transition-all p-6 cursor-pointer h-full`}>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-400">{kursus.niveau} · {kursus.moduler} moduler</span>
